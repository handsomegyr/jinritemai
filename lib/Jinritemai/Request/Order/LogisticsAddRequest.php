 ...
 * 请求示例
 * https://openapi-fxg.jinritemai.com/order/logisticsAdd?app_key=your_app_key_here&access_token=your_accesstoken_here&method=order.logisticsAdd&param_json={"company":"顺丰速递","logistics_code":"9595123123","logistics_id":"12","order_id":"order_id_here"}&timestamp=2018-06-19%2016:06:59&v=2&sign=your_sign_here
 * 响应示例
 * {
 * "err_no": 0,
 * "message": "success",
 ...
 * }
 */
class LogisticsAddRequest extends \Jinritemai\Request\Base
{
	// API名
	protected $methodName = "order/logisticsAdd";
